package lk.jl.layeredarchitecture.controller;
...
public class MainFormController {
    ...
    private void navigate(MouseEvent event) throws IOException {
        if (event.getSource() instanceof ImageView) {
            ...
            switch (icon.getId()) {
                case "imgCustomer":
                    root = FXMLLoader.load(this.getClass().getResource( "/lk/jl/layeredarchitecture/manage-customers-form.fxml" ));
                    break;
                case "imgItem":
                    root = FXMLLoader.load(this.getClass().getResource( "/lk/jl/layeredarchitecture/manage-items-form.fxml" ));
                    break;
                case "imgOrder":
                    root = FXMLLoader.load(this.getClass().getResource( "/lk/jl/layeredarchitecture/place-order-form.fxml" ));
                    break;
                case "imgViewOrders":
                    printOrderDetails();
                    root = null;
